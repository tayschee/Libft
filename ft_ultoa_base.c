...
/*   Updated: 2019/11/15 11:28:57 by tbigot           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	count_malloc(unsigned long nb, int size_base)
{
	int i;
...
static char	*nbr_base_in_char(char *txt, unsigned long int nbr,
char *base, int i)
{
	int size_base;
